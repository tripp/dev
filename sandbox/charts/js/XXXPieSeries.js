...
Y.PieSeries = Y.Base.create("pieSeries", Y.MarkerSeries, [], { 
    ...
    _getHotspot: function()
    {
        ...
        {
            hotspot = document.createElement("area");
            this._map.appendChild(hotspot);
        }
    ...
    _clearHotspotCache: function()
    {
        ...
        for(; i < len; ++i)
        {
            ...
            if(hotspot && this._map)
            {
                this._map.removeChild(hotspot);
            }
        }
        this._hotspotCache = [];
    },
